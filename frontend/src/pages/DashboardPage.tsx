    ...
    <section className="dashboard-page">
      <div className="dashboard-hero-grid">
        <div className="dashboard-hero-copy">
          ...
          <div className="hero-actions">
            <a className="primary-button" href="/projects">+ Create Project</a>
            <a className="secondary-button" href="/projects">View Workspace</a>
          </div>
        </div>
      ...
      <div className="dashboard-main-grid">
          ...
          {data.focus_task ? (
            <div className="focus-task">
              ...
              <div className="panel-actions">
                <a className="primary-button compact" href="/tasks">Open Task Center</a>
                <a className="secondary-button compact" href="/tasks">View Tasks</a>
              </div>
            </div>
          ) : (
        ...
        <article className="panel-card projects-panel">
          <PanelHeading kicker="Workspaces" title="Recent Projects" trailing={<a href="/projects" className="text-link">View all</a>} />
          {data.latest_projects.length ? (
            <div className="project-list">
              {data.latest_projects.map((project) => (
                <a href={`/projects/${project.id}`} className="project-row" key={project.id}>
          ...
          {data.upcoming_tasks.length ? (
            <div className="deadline-list">
              {data.upcoming_tasks.map((task) => (
                <a href="/tasks" className="deadline-row" key={task.id}>
