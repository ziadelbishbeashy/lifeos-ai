...
function AssessmentFields({ value, editing = false }: { value?: ModuleAssessment; editing?: boolean }) {
  return <>
    ...
    <TimePicker12hField name="assessment_time" defaultValue={value?.assessment_time?.slice(0,5) || ""} allowEmpty ariaLabel="Assessment time" />
    <input name="due_date" type="date" defaultValue={value?.due_date || ""} />
    <TimePicker12hField name="due_time" defaultValue={value?.due_time?.slice(0,5) || ""} allowEmpty ariaLabel="Due time" />
